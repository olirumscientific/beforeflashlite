        ...
        contentArea.innerHTML = `
            <div class="hero-section">
                ...
                <div class="hero-content">
                    ...
                    <button onclick="navigateTo('all-products')" style="background: var(--accent-blue); color: white; padding: 15px 35px; border: none; border-radius: 5px; font-weight: bold; font-size: 1.1rem; cursor: pointer; transition: all 0.3s;">
                        Explore Our Catalog
                    </button>
                </div>
            </div>

            <!-- THE NEW BALANCED MARKETING SECTION -->
            <div style="max-width: 1200px; margin: 60px auto; padding: 0 20px;">
                ...
                <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 30px;">
                    ...
                    <!-- Card 1: Assays -->
                    <div style="background: white; padding: 30px; border-radius: 8px; box-shadow: 0 4px 15px rgba(0,0,0,0.05); border-top: 4px solid #10b981; display: flex; flex-direction: column;">
                        ...
                        <a href="#" onclick="filterCategory(1)" style="color: #10b981; font-weight: 600; text-decoration: none;">Explore Assays &rarr;</a>
                    </div>

                    <!-- Card 2: Microscopy -->
                    <div style="background: white; padding: 30px; border-radius: 8px; box-shadow: 0 4px 15px rgba(0,0,0,0.05); border-top: 4px solid #8b5cf6; display: flex; flex-direction: column;">
                        ...
                        <a href="#" onclick="filterCategory(2)" style="color: #8b5cf6; font-weight: 600; text-decoration: none;">View Microscopy Tools &rarr;</a>
                    </div>

                    <!-- Card 3: Mycoplasma (Slide 2 Integration) -->
                    <div style="background: white; padding: 30px; border-radius: 8px; box-shadow: 0 4px 15px rgba(0,0,0,0.05); border-top: 4px solid var(--accent-blue); display: flex; flex-direction: column;">
                        ...
                        <a href="#" onclick="filterCategory(3)" style="color: var(--accent-blue); font-weight: 600; text-decoration: none;">View Mycoplasma Kits &rarr;</a>
                    </div>
...
function renderProductCards(products) {
    ...
    products.forEach(product => {
        ...
        // 1. Make the WHOLE card a clickable pointer
        ...
        card.innerHTML = `
            ...
            <!-- 2. Stop the click from registering if they are just trying to use the cart buttons -->
